...
def dashboard_view(request: HttpRequest) -> HttpResponse:
    return render(request, "showcase/cabinet/dashboard/index.html",
...
def staff_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "showcase/cabinet/staff/index.html",
                  ShowcaseMockData.get_staff_context(segment=segment, q=q))
...
def clients_view(request: HttpRequest) -> HttpResponse:
    segment = request.GET.get("segment", "all")
    q = request.GET.get("q", "").strip().lower()
    return render(request, "showcase/cabinet/clients/index.html",
                  ShowcaseMockData.get_clients_context(segment=segment, q=q))
...
def conversations_view(request: HttpRequest) -> HttpResponse:
    ...
    q        = request.GET.get("q", "").strip().lower()
    return render(request, "showcase/cabinet/conversations/index.html",
...
def booking_view(request: HttpRequest) -> HttpResponse:
    return render(request, "showcase/cabinet/booking/index.html",
...
def booking_appointments_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "showcase/cabinet/booking/appointments.html",
...
def booking_new_view(request: HttpRequest) -> HttpResponse:
    return render(request, "showcase/cabinet/booking/new.html",
                  ShowcaseMockData.get_booking_new_context())
...
def reports_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, "showcase/cabinet/analytics/reports.html",
...
def catalog_view(request: HttpRequest, category_pk: int | None = None) -> HttpResponse:
    return render(request, "showcase/cabinet/catalog/index.html",
                  ShowcaseMockData.get_catalog_context(category_pk=category_pk))
